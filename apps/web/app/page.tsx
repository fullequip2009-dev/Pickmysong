    ...
    <main className="min-h-screen bg-black">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 text-center">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <button className="rounded-full bg-purple-600 px-8 py-4 text-lg font-semibold text-white transition-all hover:bg-purple-500 hover:scale-105 active:scale-100">
              Empieza ahora
            </button>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {['Vota canciones', 'Crea playlists', 'Descubre artistas', 'Para locales', 'Para marcas'].map(
              (feature) => (
                <span
                  key={feature}
      ...
      <section className="flex flex-col items-center gap-6 py-24 px-4 text-center">
        ...
        <p className="max-w-lg text-gray-400">
          Estamos construyendo algo increíble. Sé el primero en enterarte cuando lancemos.
        </p>
        <form className="flex w-full max-w-md gap-2">
          <input
            type="email"
            placeholder="Tu email"
            className="flex-1 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-white placeholder-gray-500 outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
          />
          <button
            type="submit"
            className="rounded-full bg-purple-600 px-6 py-3 font-semibold text-white hover:bg-purple-500"
          >
            Notifícame
          </button>
        </form>
