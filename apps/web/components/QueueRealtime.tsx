  ...
  if (queue.length === 0) {
    return (
      <div className="text-center py-12 text-gray-400">
        ...
        <p className="text-sm mt-1">Be the first to add a song!</p>
      </div>
    );
  }
      ...
      {queue.map((item, index) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            {item.profiles && (
              <p className="text-xs text-gray-500">by {item.profiles.display_name}</p>
            )}
          </div>
          ...
          {isAdmin && (
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-1 bg-red-600/20 hover:bg-red-600/40 text-red-400 text-xs rounded-lg transition-colors border border-red-500/20"
              >
                Skip
              </button>
            </div>
